  ...
  return (
    <div className="container mt-4 p-0">
      <div className="bg-white shadow rounded-lg p-6">
        <h2 className="text-2xl font-semibold mb-2">{repoDetails.name}</h2>
        <p className="text-gray-700 mb-4">{repoDetails.description}</p>
        <div className="flex justify-between items-center">
          <span className="text-gray-600">⭐ {repoDetails.stars}</span>
          <span className="text-gray-600">{repoDetails.language}</span>
          <a
